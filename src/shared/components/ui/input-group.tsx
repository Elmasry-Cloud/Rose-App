  ...
  return (
    <div
      ...
      className={cn(
        ...
        'p-4 rounded-base border-input',

        // Default
        'bg-ds-bg-plain border border-ds-border-muted',
...
const inputGroupAddonVariants = cva(
  cn(
    // Base
    'flex h-auto cursor-text items-center justify-center gap-2 py-1.5 select-none',
...
function InputGroupInput({ className, ...props }: React.ComponentProps<'input'>) {
  return (
    <Input
      ...
      className={cn(
        // Base
        'flex-1 border-0 rounded-none shadow-none',

        // Default
        'bg-transparent',

        // Focus / Invalid
        'ring-0 focus-visible:ring-0 aria-invalid:ring-0',
...
function InputGroupTextarea({ className, ...props }: React.ComponentProps<'textarea'>) {
  return (
    <Textarea
      ...
      className={cn(
        // Base
        'flex-1 resize-none border-0 rounded-none shadow-none py-2',
